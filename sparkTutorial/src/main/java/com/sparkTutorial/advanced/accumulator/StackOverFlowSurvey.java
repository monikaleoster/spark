...
public class StackOverFlowSurvey {
    ...
    public static void main(String[] args) throws Exception {
        ...
        bytesProcessed.register(sparkContext, Option.apply("Bytes Processed"), true);
        ...
        JavaRDD<String> responseFromCanada = responseRDD.filter(response -> {
            ...
            total.add(1);
            bytesProcessed.add(response.getBytes().length);
        ...
        System.out.println("BytesProcessed: " + bytesProcessed.value());
